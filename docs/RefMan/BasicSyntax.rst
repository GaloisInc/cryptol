...
.. code-block:: none
  ...
  by              else         include        let            pragma         then     
  case            enum         infix          module         primitive      type     
  constraint      foreign      infixl         newtype        private        where    
  deriving        if           infixr         of             property     
  down            import       interface      parameter      submodule    
