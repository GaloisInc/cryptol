...
>
>    , "fpIsPos"     ~> vFinPoly \_ -> pure $
>                       vFinPoly \_ -> pure $
>                       VFun \xv ->
>                         do x <- fromVFloat <$> xv
>                            pure (VBit (FP.bfIsPos x))
>
...
>           rm' <- eitherToE (FP.fpRound rm)
>           x <- fromVFloat' <$> xv
>           pure $ vWord n $ FP.floatToBV (fromInteger @Natural n) rm' x
>    , "fpToSBV" ~>
>      vFinPoly \n -> pure $
>      vFinPoly \_e -> pure $
>      vFinPoly \_p -> pure $
...
>           rm' <- eitherToE (FP.fpRound rm)
>           x <- fromVFloat' <$> xv
>           pure $ vWord n $ FP.floatToSBV (fromInteger @Natural n) rm' x
>    ]
>   where
