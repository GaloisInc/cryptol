...
instance Backend SBV where
  ...
  fpPlus sym _ _ _      = raiseError sym (UnsupportedSymbolicOp "fpPlus")
  fpMinus sym _ _ _     = raiseError sym (UnsupportedSymbolicOp "fpMinus")
  fpMult sym  _ _ _     = raiseError sym (UnsupportedSymbolicOp "fpMult")
  fpDiv sym _ _ _       = raiseError sym (UnsupportedSymbolicOp "fpDiv")
